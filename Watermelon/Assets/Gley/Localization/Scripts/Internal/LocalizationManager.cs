...
namespace Gley.Localization.Internal
{
    public class LocalizationManager : MonoBehaviour
    {
        ...
        void Initialize()
        {
            ...
            LocalizationData localizationSettings = Resources.Load<LocalizationData>(Constants.DATA_NAME_RUNTIME);
        ...
        {
            var localizationComponents = FindObjectsByType<MonoBehaviour>(FindObjectsSortMode.None).OfType<ILocalizationComponent>();
