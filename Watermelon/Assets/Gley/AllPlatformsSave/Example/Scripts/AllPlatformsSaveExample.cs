...
{
    public class AllPlatformsSaveExample : MonoBehaviour
    {
        //local data
        string randomText = "";
        bool showVideo;
        ...
        //if true data will be encrypted with an XOR function
        bool encrypt = false;
        ...
        public void SaveGameValues()
        {
            ...
            Gley.AllPlatformsSave.API.Save(gameValues, fullPath, DataWasSaved, encrypt);
        }
        ...
        {
            logText += "\nClear";
            Gley.AllPlatformsSave.API.ClearFile(fullPath);
        }
